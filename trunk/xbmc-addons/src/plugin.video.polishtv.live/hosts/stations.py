...
#           [ "ATM Rozrywka", 0, "rtsp://publish.001.wlacz.tv:1935/live/atm.stream" ],
 ...
 #          [ "Poslkie stacje radiowe", 0, "http://xbmc.cba.pl/zbmc/onair.m3u" ],
            ...
            [ "Białystok Rynek Kościuszki", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera35.stream" ],
            [ "Ciechocinek, fontanna Grzybek", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera53.stream" ],
            [ "Darłowo Hotel Apollo", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera37.stream" ],
            [ "Gdańsk ul.Długa", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera31.stream" ],
            [ "Gogołów, wyciąg narciarski Pod Dziedzicem", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera46.stream" ],
            [ "Jastarnia", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera58.stream" ],
            [ "Korbielów, kolej krzesełkowa BABA", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera50.stream" ],
            [ "Korbielów, Schronisko na Hali Miziowej", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera65.stream" ],
            [ "Krajno, Park Rozrywki Sabat Krajno", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera52.stream" ],
            [ "Kraków Rynek Główny", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera9.stream" ],
            [ "Kraków ul. Floriańska", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera8.stream" ],
            [ "Kuźnica (Jastarnia)", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera57.stream" ],
            [ "Łeba - Plaża, Agados", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera33.stream" ],
            [ "Łódź Plac Wolności", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera19.stream" ],
            [ "Łódź Rondo Solidarności", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera20.stream" ],
            [ "Łódź ul.Piotrkowska", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera7.stream" ],
            [ "Międzybrodzie Bialskie, kompleks RELAKS", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera62.stream" ],
            [ "Poznań Stary Rynek", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera24.stream" ],
            [ "Poznań ul.Głogowska", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera22.stream" ],
            [ "Poznań ul.Hetmańska / ul.Głogowska", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera21.stream" ],
            [ "Poznań, Lodowisko Chwiałka", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera63.stream" ],
            [ "Sopot Klub Atelier", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera32.stream" ],
            [ "Góra Kamieńsk Stok narciarski", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera25.stream" ],
            [ "Szczyrk, Hotel Meta", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera48.stream" ],
            [ "Szczyrk, Kompleks narciarski Biały Krzyż", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera68.stream" ],
            [ "Ustka Restauracja Korsarz", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera38.stream" ],
            [ "Ustroń, Kolej Linowa Palenica", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera61.stream" ],
            [ "Warszawa Al. Jana Pawła II / ul.Anielewicza", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera2.stream" ],
            [ "Warszawa Al. Solidarności / Al. Jana Pawła II", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera15.stream" ],
            [ "Warszawa Plac Konstytucji", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera18.stream" ],
            [ "Warszawa ul.Chmielna", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera12.stream" ],
            [ "Warszawa ul.Marszałkowska", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera6.stream" ],
            [ "Warszawa, Plac Defilad", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera16.stream" ],
            [ "Wisła, Kolej Linowa Cieńków", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera49.stream" ],
            [ "Wisła, Ośrodek Narciarski Nowa Osada", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera47.stream" ],
            [ "Wisła, Ośrodek Narciarski Stożek", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera51.stream" ],
            [ "Wrocław Hostel Tu i Teraz", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera28.stream" ],
            [ "Wrocław Rynek", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera27.stream" ],
            [ "Wrocław ul. Wyszyńskiego", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera26.stream" ],
            [ "Wrocław ul.Świdnicka, Cafe Borówka", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera29.stream" ],
            [ "Zagroń Istebna, ośrodek narciarski", 8,"rtmp://vod.wowza.astrosa.pl/rtplive/:camera64.stream" ],
