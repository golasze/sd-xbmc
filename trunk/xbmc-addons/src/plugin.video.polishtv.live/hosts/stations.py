...
MENU_TAB = [  
            [ "TVN", 0, "rtmp://198.105.217.36/stream/aletv1?id=78477" ],
            [ "TVP Polonia", 0, "rtsp://publish.001.wlacz.tv:1935/live/tvppolonia.stream" ],
            [ "Polsat", 0, "rtmp://198.105.220.36/stream/aletv3?id=78481" ],
            [ "Discovery ", 0, "rtmp://94.23.39.164/tvon/discovery playpath=discovery swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-145.htm  live=true swfVfy=true" ],
#           [ "Polsat LQ1", 0, "rtmp://93.174.93.65/live/PolsatTelewizyjkapl" ],
            [ "Polsat News", 1, "rtmp://94.23.39.164/tvon/n24 playpath=n24 swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-129.htm  live=true swfVfy=true" ],
...
#           [ "Polsat", 0, "rtmp://198.105.209.124/stream/JardelloTV4343?id=59200" ],
            [ "TVN24", 1, "rtmp://199.9.254.83/app/jtv_64yOdhtZd3gDw4ia" ],
#           [ "Polsat LQ", 0, "rtmp://75.126.203.130/stream/darmowatelewizjacompolsat?id=59168" ],
            [ "Canal Plus", 0, "rtmp://94.23.39.164/tvon/canalplus playpath=canalplus swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-138.htm  live=true swfVfy=true" ],
            [ "TV4", 0, "rtsp://publish.001.wlacz.tv:1935/live/tv4.stream" ],
#           [ "National Geographic", 0, "rtmp://creyden.popler.tv:80/rtplive?play=123452/istreampl5" ],
            [ "TV Puls", 0, "rtsp://publish.001.wlacz.tv:1935/live/puls.stream" ],
...
#           [ "TTV", 0, "rtmp://gdansk.popler.tv:80/rtplive?play=123452/admin245" ],
            ...
            [ "TVP1", 0, "rtmp://94.23.39.164/tvon/hd989wizja1 playpath=hd989wizja1 swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-126.htm  live=true swfVfy=true" ],                      
            ...
            [ "Canal Plus Film", 0, "rtmp://94.23.39.164/tvon/canalplusfilm playpath=canalplusfilm swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-137.htm live=true swfVfy=true" ],
            [ "TVP INFO ", 1, "http://195.245.213.200//Ch0012" ],
...
#           [ "Canal Plus Gol (I-stream.pl)", 2, "rtmp://50.7.28.178/app/14918 playpath=14918 swfUrl=http://static2.sawlive.tv/player.swf pageUrl=http://i-stream.pl/kanal-2 live=true swfVfy=true" ],        
            ...
            [ "Polsat Sport", 0, "rtmp://94.23.39.164/tvon/polsatsport playpath=polsatsport swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-124.htm  live=true swfVfy=true" ],

            [ "Canal Plus Gol (TV-ON.PL)", 2, "rtmp://94.23.39.164/tvon/canalplusgol playpath=canalplusgol swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-121.htm  live=true swfVfy=true" ],
            [ "Eurosport (TV-ON.PL)", 2, "rtmp://94.23.39.164/tvon/eurosport playpath=eurosport swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-122.htm  live=true swfVfy=true" ],
            [ "Eurosport2 (TV-ON.PL)", 2, "rtmp://94.23.39.164/tvon/eurosport2 playpath=eurosport2 swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-123.htm  live=true swfVfy=true" ],
            [ "TVP Sport (TV-ON.PL)", 2, "rtmp://94.23.39.164/tvon/tvps playpath=tvps swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-140.htm live=true swfVfy=true" ],
            [ "Canal Plus Sport (TV-ON.PL)", 2, "rtmp://94.23.39.164/tvon/niekradnijchamie playpath=niekradnijchamie swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-120.htm live=true swfVfy=true" ],
            ...
            [ "TVP 2", 0, "rtmp://37.130.228.28/stream/aletv2?id=78480" ],
            ...
            [ "TV Kujawy", 5, "rtmp://stream.tvkujawy.pl/live/broadcast" ],
...
#           [ "TV Toruń ", 5, "http://217.173.176.107:1935/live/ngrp:tvk.stream_all/chunklist-b1399547.m3u8?wowzasessionid=1841105475" ],
            ...
            [ "Telewizja lubuszan", 5, "rtmp://212-105.livestream.com/mogulus-stream-edge/tllive/rtmp://212-94.livestream.com/mogulus/tllive/e6cc3871-5097-44dd-a6db-b78d69935a69" ],
