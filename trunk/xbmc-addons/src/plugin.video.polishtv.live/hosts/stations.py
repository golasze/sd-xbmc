...
MENU_TAB = [  
            [ "TVN", 0, "rtmp://94.23.39.164/tvon/tvnup playpath=tvnup swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-127.htm  live=true swfVfy=true" ],
            [ "ATM Rozrywka", 0, "rtmp://creyden.popler.tv:80/rtplive?play=123452/fdg4324" ],
            [ "TVP2", 0, "rtmp://94.23.39.164/tvon/p2 playpath=p2 swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-131.htm  live=true swfVfy=true" ],
#           [ "TVN", 0, "rtmp://75.126.203.130/stream/JardelloTV3333?id=59199" ],
#           [ "Polsat LQ1", 0, "rtmp://93.174.93.65/live/PolsatTelewizyjkapl" ],
            [ "TVN24", 1, "rtmp://94.23.39.164/tvon/n24 playpath=n24 swfUrl=http://tv-on.pl/player/videoPlayer.swf pageUrl=http://tv-on.pl/stream,id-129.htm  live=true swfVfy=true" ],
