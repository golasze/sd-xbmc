...
MENU_TAB = [  
            [ "TVN", 0, "rtmp://94.23.39.164/satlive/tvnn playpath=tvnn swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-127.htm  live=true swfVfy=true" ],
...
#           [ "Polsat LQ1", 0, "rtmp://93.174.93.65/live/PolsatTelewizyjkapl" ],
            ...
            [ "SkyWindows", 0, "rtmp://h264.webcamera.pl:443/nartytv/tv_medium" ],
...
#           [ "Polsat LQ", 0, "rtmp://75.126.203.130/stream/darmowatelewizjacompolsat?id=59168" ],
            [ "Canal Plus", 0, "rtmp://94.23.39.164/satlive/channel1 playpath=channel1 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-120.htm  live=true swfVfy=true" ],
...
#           [ "Discovery Science", 0, "rtmp://creyden.popler.tv:80/rtplive?play=123452/istreampl2" ],
            ...
            [ "TVP1", 0, "rtmp://94.23.39.164/satlive/tvp11 playpath=tvp11 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-126.htm  live=true swfVfy=true" ],            
            ...
            [ "Canal Plus Film", 0, "rtmp://94.23.39.164/satlive/canaplusfilm playpath=canaplusfilm swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-137.htm live=true swfVfy=true" ],
            ...
            [ "Chanel 1 (TV-ON.PL)", 2, "rtmp://94.23.39.164/satlive/chanel1 playpath=chanel1 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-120.htm  live=true swfVfy=true" ],
            [ "Chanel 2 (TV-ON.PL)", 2, "rtmp://94.23.39.164/satlive/chanel2 playpath=chanel2 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-121.htm  live=true swfVfy=true" ],
#           [ "Eurosport2 (satlive.pl)", 2, "rtmp://94.23.39.164/satlive/channel5 playpath=channel5 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://satlive.pl/stream,id-124.htm  live=true swfVfy=true" ],
            [ "Chanel 3 (TV-ON.PL)", 2, "rtmp://94.23.39.164/satlive/chanel3 playpath=chanel3 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-122.htm live=true swfVfy=true" ],
...
#           [ "nSport (satlive.pl)", 2, "rtmp://94.23.39.164/satlive/channel6 playpath=channel6 swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://satlive.pl/stream,id-125.htm  live=true swfVfy=true" ],
            [ "Polsat", 0, "rtmp://94.23.39.164/satlive/polsat playpath=polsat swfUrl=http://tv-on.pl/player/player.swf pageUrl=http://tv-on.pl/stream,id-128.htm  live=true swfVfy=true" ],
            ...
            [ "TVN TURBO", 0, "rtmp://94.23.39.164/satlive/tvntrbo playpath=tvntrbo swfUrl=http://tv-on.pl/player/sat.swf pageUrl=http://tv-on.pl/stream,id-132.htm live=true swfVfy=true" ],
