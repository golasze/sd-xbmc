...
megavideologin = s.MegaVideoLogin
megavideopassword = s.MegaVideoPassword
modoPremium = s.MegaVideoEnable
...
def getcode(mega):
	...
	if mega.startswith('http://www.megavideo.com/?v='):
		mega = mega[-8:]
	elif mega.startswith('http://www.megavideo.com/v/'):
		mega = mega[-8:]
	xbmc.output("[megavideo.py] mega="+mega)
	return mega
...
def getlowurl(code):
	...
	if modoPremium == "false":
		...
		xbmc.output("http://www.megavideo.com/xml/videolink.php?v="+code)
